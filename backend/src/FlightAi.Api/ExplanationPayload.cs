...
/// <summary>
/// The <c>explanation</c> SSE event's payload, per docs/reference/06-api-sse-contract.md. <see cref="Text"/> is
...
/// or a stray digit/word was found outside a token; see docs/reference/02-price-integrity.md.
/// </summary>
