...
**Side one — `PriceReferenceStore`** (`FlightAi.Core/Pricing/PriceReferenceStore.cs`). Given a set of
...
**Side two — `ExplanationPlaceholderRenderer`** (`FlightAi.Core/Pricing/ExplanationPlaceholderRenderer.cs`).
