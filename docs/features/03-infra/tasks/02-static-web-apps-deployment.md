# F08 — Static Web Apps deployment

**Roadmap step:** 5. Deployment
**Source doc:** `docs/deployment.md`, `infra/README.md`
**Depends on:** F03 (at minimum), backend 19
...
|---|---|---|---|
| E1 | `az bicep build` on the new module and `main.bicep` | Clean | Same pre-flight discipline as backend task 22 E1 |
...
| E7 | The published bundle, grepped | No API key, no signing key, no secret of any kind | Everything shipped here is public by definition. Task 17 D1 and task 21 both depend on this staying true |
